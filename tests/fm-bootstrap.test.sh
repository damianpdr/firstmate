...
omp verified harness with valid effort is accepted^{"rules":[{"when":"omp work","use":{"harness":"omp","model":"omp-4","effort":"high"}}]}^empty^
omp max effort is accepted^{"rules":[{"when":"deep omp work","use":{"harness":"omp","model":"omp-4","effort":"max"}}]}^empty^
